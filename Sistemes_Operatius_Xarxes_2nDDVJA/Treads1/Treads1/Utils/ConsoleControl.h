...
public:
	...
	enum ConsoleColor
	{
		BLACK, DARKBLUE, DARKGREEN, DARKCYAN, DARKRED, DARKMAGENTA, DARKGREY, BLUE, GREEN, CYAN, RED, MAGENTA, YELLOW, WHITE
	};
	...
	static int WaitForNextKey();

	static char WaitForNextChar();
